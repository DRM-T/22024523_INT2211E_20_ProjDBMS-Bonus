...
public class admin_interface {
    ...
    @FXML
    private Button dict, voca, historyUpdate, user, quit, logout;
    ...
    public void initialize() {
        ...
        showComponent("/view_admin/dictionaryManagement.fxml");
        setButton(dict, "/view_admin/dictionaryManagement.fxml");
        setButton(voca, "/view_admin/vocaMannagement.fxml");
        setButton(historyUpdate, "/view_admin/historyUpdate.fxml");
        setButton(user, "/view_admin/userMannagement.fxml");
