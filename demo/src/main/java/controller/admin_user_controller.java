...
public class admin_user_controller implements Initializable {
    ...
    @FXML
    private TableView<ObservableList<String>> tableUser, tableStudy, tableStudyDetail, tableAdmin;

    @Override
    public void initialize(URL url, ResourceBundle resourceBundle) {
        loadDataFromDatabase("users", tableUser);
        loadDataFromDatabase("learninghistory", tableStudy);
        loadDataFromDatabase("learninghistorydetail", tableStudyDetail);
        loadDataFromDatabase("admin", tableAdmin);
